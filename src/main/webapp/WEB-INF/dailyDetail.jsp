...
<div style="margin:20px 30px 20px 30px;">
    ...
    <table id="dg" class="easyui-datagrid" title="日报填写" style="width:100%;height:auto"
        ...
        <tr>
            ...
            <th width="20%" data-options="field:'remark',align:'center',editor:{type:'textbox',options:{multiline:true,height:50}}">备注</th>
            <th width="6%" data-options="field:'state',align:'center',editor:{type:'textbox',options:{multiline:true,height:50}}">状态</th>
